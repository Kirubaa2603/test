...
if user_input:
    ...
    sad_words = ["sad", "down", "depressed", "unhappy"]
    encouraging_responses = [
        "You're not alone, and you are stronger than you think! 💙",
        "Sending you a virtual hug! Things will get better. 💫",
        "Keep pushing forward, you’ve got this! 🌟",
        "Even on tough days, you are still amazing! 💖"
    ]
    
    if any(word in user_input.lower() for word in greetings):
        response = "Hey there! 😊 How can I help today?"
    elif any(word in user_input.lower() for word in sad_words):
